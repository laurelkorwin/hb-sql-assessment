...
SELECT models.name, models.brand_name, brands.founded
...
FROM brands LEFT JOIN models ON (brands.name = models.brand_name)
...
SELECT brands.name FROM brands JOIN models ON (brands.name = models.brand_name)
